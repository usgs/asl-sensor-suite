...
public class RandomizedExperiment extends Experiment {
   ...
   * This may be useful when trying to run the solver over a high-frequency calibration
   * where the data is particularly noisy in some of the higher-frequency bounds,
   * causing a bad corner fit to occur. We also enforce this to be over 0.3 as well.
   *
